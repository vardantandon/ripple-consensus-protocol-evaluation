...
if __name__ == "__main__":
    ...
    # Varying Network size while keeping other parameters fixed
    num_nodes_list = list(range(100,1100,100))#100,200..1000
    mal_node_list = list(range(10,15, 5)) #10
    nodes_conn_list = list(range(5, 10, 5)) #5
    ...
    min_c2c_latency = list(range(5, 15, 10)) #5
    max_c2c_latency = list(range(200, 210, 10)) #200
