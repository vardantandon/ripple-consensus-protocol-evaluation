...
def main(input_values):
    ...
    print('Ran a simulation with ' + str(e2c_latency_range) + ' end to core latency range and '
          +str(c2c_latency_range)+ ' core to core latency range.')
    return simulation_summary

if __name__ == "__main__":

    # Varying the Network latency range while keeping other parameters fixed
    num_nodes_list = list(range(100,200,100))#100
    mal_node_list = list(range(15,20,5))#15
    nodes_conn_list = list(range(10, 15, 5))#15
    unl_min = list(range(5, 10, 5))#5
    unl_max = list(range(15, 20, 5))#15
    unl_list = list(zip(unl_min, unl_max))#(5-15)
    min_e2c_latency = list(range(10, 35, 5))#10,15..30
    max_e2c_latency = list(range(50, 75, 5))#50,55..70
    e2c_latecy_list = list(zip(min_e2c_latency, max_e2c_latency))
    min_c2c_latency = list(range(10, 35, 5))#10,15..30
    max_c2c_latency = list(range(200, 235, 5))#200,205..230
    c2c_latecy_list = list(zip(min_c2c_latency, max_c2c_latency))
