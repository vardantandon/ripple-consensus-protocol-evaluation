...
if __name__ == "__main__":
    ...
    min_e2c_latency = list(range(5, 30, 5))#5,10..25
    max_e2c_latency = list(range(55, 80, 5))#55,60..75
    e2c_latecy_list = list(zip(min_e2c_latency, max_e2c_latency))
    min_c2c_latency = list(range(5, 30, 5))#5,10..25
    max_c2c_latency = list(range(205, 240, 5))#205,210..235
