...
def main(input_values):
    ...
    print('Ran a simulation with (' + str(unl_min) +',' +str(unl_max)+ ') UNL range')
    return simulation_summary

if __name__ == "__main__":

    # Varying the UNL range while keeping other parameters fixed
    num_nodes_list = list(range(100,200,100))#100
    mal_node_list = list(range(15,20,5))#15
    nodes_conn_list = list(range(10, 15, 5))#10
    unl_min = list(range(10, 35, 5))#10,15..30
    unl_max = list(range(15, 40, 5))#15,20..35
    unl_list = list(zip(unl_min, unl_max))#(10,15)(15,20)..(30,35)
