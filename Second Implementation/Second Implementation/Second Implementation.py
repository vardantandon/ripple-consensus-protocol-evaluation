...
if __name__ == "__main__":
    ...
    # Example range of Input values that can be experimented
    num_nodes_list = list(range(100,300,100)) # Taking 100 and 200 servers
    mal_node_list = list(range(10,20, 5)) # Taking 10 and 15 malicious servers
    nodes_conn_list = list(range(10, 20, 5)) # Taking 10 and 15 output links
    unl_min = list(range(5, 15, 5)) # Taking min unl 5 and 10
    unl_max = list(range(15, 25, 5)) # Taking max unl 15 and 20
    unl_list = list(zip(unl_min, unl_max)) # Taking two unl ranges (5,15) and (10,20)
    min_e2c_latency = list(range(5, 15, 5)) # Taking min e2c latency 5 and 10
    max_e2c_latency = list(range(50, 60, 5)) # Taking max e2c latency 50 and 55
    e2c_latecy_list = list(zip(min_e2c_latency, max_e2c_latency)) # Taking two e2c latency ranges (5,50) and (10,55)
    min_c2c_latency = list(range(5, 15, 5)) #Taking min c2c latency 5 and 10
    max_c2c_latency = list(range(200, 210, 5)) # taking max c2c latency 200 and 210
    c2c_latecy_list = list(zip(min_c2c_latency, max_c2c_latency)) # Taking two c2c latency ranges (5,200) and (10,205)
