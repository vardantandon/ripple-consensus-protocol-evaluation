...
def main(input_values):
    ...
    print('Ran a simulation with each server having ' + str(server_outbound_links) + ' outbound connections.')
    return simulation_summary

if __name__ == "__main__":

    # Varying Number of outbound links while keeping other parameters fixed
    num_nodes_list = list(range(100,200,100))#100
    mal_node_list = list(range(10,15,5))#10
    nodes_conn_list = list(range(5, 35, 5))#5,10..30
